...
--
-- Servidor: localhost
-- Tiempo de generación: 09-06-2017 a las 21:37:08
...
CREATE TABLE IF NOT EXISTS `carrera` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_carrera_circuit1_idx` (`circuit_id`)
...
(1, '2017 Formula 1 Rolex Australian GP', '2017-03-26', 1),
(2, '2017 Formula 1 Heineken Chinese GP', '2017-04-09', 2),
(3, '2017 Formula 1 Gulf Air GP', '2017-04-16', 3),
(4, '2017 Formula 1 VTB Russian GP', '2017-04-30', 4),
(5, 'GP de España Pirelli 2017', '2017-05-14', 5),
(6, 'GP de Mónaco 2017', '2017-05-28', 6),
(7, 'GP du Canada 2017', '2017-06-11', 7),
(8, '2017 GP of Europe', '2017-06-25', 8),
(9, 'Formula 1 GP von Österreich 2017', '2017-07-09', 9),
(10, '2017 Formula 1 Rolex British GP', '2017-07-16', 10),
(11, 'Formula 1 Pirelli Magyar Nagydíj 2017', '2017-07-30', 11),
(12, 'Formula 1 Pirelli Belgian 2017', '2017-08-27', 13),
(13, 'Formula 1 GP Heineken d''Italia 2017', '2017-09-03', 14),
(14, '2017 Formula 1 Singapore Airlines GP', '2017-09-17', 15),
(15, '2017 Formula 1 Petronas Malaysia GP', '2017-10-01', 16),
(16, '2017 Formula 1 Japanese GP', '2017-10-08', 17),
(17, '2017 United States GP', '2017-10-22', 18),
(18, 'GP de México 2017', '2017-10-29', 19),
(19, 'Formula 1 GP Heineken do Brasil 2017', '2017-11-12', 20),
(20, '2017 Formula 1 Etihad Airways Abu Dhabi GP', '2017-11-26', 21),
(21, '2016 Formula 1 Rolex Australian GP', '2016-03-20', 1),
(22, '2016 Formula 1 Gulf Air GP', '2016-04-03', 3),
(23, '2016 Formula 1 Pirelli Chinese GP', '2016-04-17', 2),
(24, '2016 Formula 1 Russian GP', '2016-05-01', 4),
(25, 'GP de España Pirelli 2016', '2016-05-15', 5),
(26, 'GP de Mónaco 2016', '2016-05-29', 6),
(27, 'GP du Canadá 2016', '2016-06-12', 7),
(28, '2016 GP of Europe', '2016-06-19', 8),
(29, 'Formula 1 GP von Österreich 2016', '2016-07-03', 9),
(30, '2016 Formula 1 British GP', '2016-07-10', 10),
(31, 'Formula 1 Magyar Nagydíj 2016', '2016-07-24', 11),
(32, 'Formula 1 GP von Deutschland 2016', '2016-07-24', 12),
(33, '2016 Formula 1 Belgian GP', '2016-07-31', 13),
(34, 'Formula 1 GP Heineken d''Italia 2016', '2016-09-04', 14),
(35, '2016 Formula 1 Singapore Airlines GP', '2016-09-18', 15),
(36, '2016 Formula 1 Petronas Malaysia GP', '2016-10-02', 16),
(37, '2016 Formula 1 Emirates Japanese GP', '2016-10-09', 17),
(38, '2016 United States GP', '2016-10-23', 18),
(39, 'GP de México 2016', '2016-10-30', 19),
(40, 'Formula 1 GP do Brasil  2016', '2016-11-13', 20),
(41, '2016 Formula 1 Etihad Airways Abu Dhabi GP', '2016-11-27', 21),
(42, '2015 Formula 1 Rolex Australian GP', '2015-03-15', 1),
(43, '2015 Formula 1 Petronas Malaysia GP', '2015-03-29', 16);
...
CREATE TABLE IF NOT EXISTS `clasificacio` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_clasificacio_pilot1_idx` (`pilot_id`),
  KEY `fk_clasificacio_carrera1_idx` (`carrera_id`)
...
CREATE TABLE IF NOT EXISTS `escuderia_usuari` (
  `scuderia_id` int(11) NOT NULL,
  `log_user_id` int(11) NOT NULL,
  PRIMARY KEY (`scuderia_id`,`log_user_id`),
  KEY `fk_scuderia_has_log_user_log_user1_idx` (`log_user_id`),
  KEY `fk_scuderia_has_log_user_scuderia1_idx` (`scuderia_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `escuderia_usuari`
--

INSERT INTO `escuderia_usuari` (`scuderia_id`, `log_user_id`) VALUES
(8, 6),
(10, 6);
...
(3, 'Alicia', 'Rossello', 'a.rossello@mail.com', '4aeeea6eb88d0e0b3afb2c9c537b63b1', '1986-06-06', 'super'),
(7, 'torpe', 'Duran', 'tduran@gmail.com', '44c35c96feb48efd8620a975e7c13598', '2017-06-20', 'registrado'),
(5, 'torbe', 'duran', 'torbeduran@gmail.com', '02a4f5120a10d2464f74805101bbb1a6', '2017-06-14', 'registrado'),
(6, 'Ally', 'Ross', 'aliciarossello@gmail.com', '9509da136a29ede4dd27631d5526b19a', '0000-00-00', 'registrado'),
(8, 'ARX', 'Xim', 'arx@hotmail.com', '7d07feeec1c9fb07bcfa72ade72df588', '2000-01-13', 'registrado'),
(9, 'alice', 'Xim', 'arx2@hotmail.com', '7d07feeec1c9fb07bcfa72ade72df588', '0000-00-00', 'registrado'),
(10, 'ARS', 'Ross', 'arosselloximenes@educaib.eu', 'ce852ec40d00cf85de9d7c0bda4f4893', '0000-00-00', 'registrado'),
(11, 'José', 'Lloret', 'pacopecos23@gmail.com', 'df298c60bc6684c67cdd6b37a3924d8a', '2017-06-23', 'super');
...
(42, 'Michael Shumacher', 'MSC', '1969-01-03', 75, 174, 1369, 250, 'Jordan', 'Alemania', 1991, 77, 91, 7),
(43, 'Bruno Sennaa', 'SEN', '1983-10-15', 69, 180, 33, 46, 'HRT ', 'Brasil', 2010, 1, 0, 0),
...
CREATE TABLE IF NOT EXISTS `pilot_usuari` (
  `pilot_id` int(11) NOT NULL,
  `log_user_id` int(11) NOT NULL,
  PRIMARY KEY (`pilot_id`,`log_user_id`),
  KEY `fk_pilots_has_log_user_log_user1_idx` (`log_user_id`),
  KEY `fk_pilots_has_log_user_pilots1_idx` (`pilot_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `pilot_usuari`
--

INSERT INTO `pilot_usuari` (`pilot_id`, `log_user_id`) VALUES
(1, 5),
(1, 7),
(2, 3),
(42, 5),
...
CREATE TABLE IF NOT EXISTS `temporada` (
  `any` year(4) NOT NULL,
  `reglament` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`any`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(2015, '<h3 style="text-align:center;color:blue;">Cambios en el Reglamento Deportivo de 2015</h3>\n\n<p>Se centra sobre todo en la reducción de horas en el túnel de viento, de jornadas de test y de unidades de propulsión para reducir los costes de la actual Fórmula 1.</p>\n\n<h4 style="text-align:center;color:grey;">Bloques de alimentación</h4>\n\n<p>A partir de 2015 cada equipo podrá usar cuatro durante la temporada, salvo si el calendario supera las veinte carreras, que pasarán a poder utilizar cinco. Además, el castigo por un cambio completo de la unidad de potencia no será partir desde pit-lane sino desde el último puesto de parrilla.</p>\n\n<h4 style="text-align:center;color:grey;">Ensayos aerodinámicos</h4>\n\n<p>El número de horas de trabajo en el túnel de viento se reducirá de 80 a 65 horas semanales.</p>\n\n<p>El funcionamiento de horas en las que puede estar funcionando el tunel de viento pasará de las 30 actuales a 25 horas por semana.</p>\n\n<p>Se permitirán dos periodos de ocupación del túnel de viento al día en lugar de uno solo.</p>\n\n<p>Los equipos de viento solo podrán designar un túnel de viento por año.</p>\n\n<h4 style="text-align:center;color:grey;">Test</h4>\n\n<p>Habrá tres pruebas de pretemporada de cuatro días de duración, todas ellas realizadas en Europa en 2015. En 2016 solo habrá dos test de cuatro días durante la pretemporada.</p>\n\n<p>Los equipos dispondrán de dos test de dos días durante la temporada, realizados en Europa. Dos de los cuatro días totales deben reservarse para los jóvenes pilotos del equipo.</p>\n\n<h4 style="text-align:center;color:grey;">Especificación del coche en un evento</h4>\n\n<p>Las actuales restricciones de parque cerrado pasarán a aplicarse desde el inicio de los entrenamientos libres 3 en lugar de desde que empiece la clasificación como hasta ahora.</p>\n\n<h4 style="text-align:center;color:grey;">Neumáticos</h4>\n\n<p>No habrá prohibición de las mantas calentadores para los neumáticos en 2015. Esto se debatirá en el futuro si el diámetro de la llanta y la rueda aumenta.</p>\n\n<h4 style="text-align:center;color:grey;">Toque de queda</h4>\n\n<p>El toque de queda de los equipos pasará de las seis horas habituales del viernes a siete durante 2015 y a ocho horas para 2016.</p>\n\n<h4 style="text-align:center;color:grey;">Reanudación de carrera tras Safety Car</h4>\n\n<p>En principio, el relanzamiento de carrera tras la aparición en pista del coche de seguridad y su marcha se llevaría a cabo desde la parrilla de salida. Sin embargo, se trataba de una medida que no convencía a los pilotos, y finalmente Bernie Ecclestone descartó las resalidas tras Safety Car.</p>\n\n<h3 style="text-align:center;color:blue;">Cambios en el Reglamento Técnico de 2015</h3>\n\n<p>El objetivo prioritario es mejorar la seguridad, y en base a ella están enfocados todos los cambios en este apartado del reglamento para el próximo año.</p>\n\n<ul>\n<li>Se establecerán una serie de regulaciones para los morros de los monoplazas, con el objetivo de aumentar la seguridad y que las estructuras sean visualmente más estéticas.</li>\n\n<li>Se implantarán nuevas regulaciones con respecto a los bloques deslizantes para confirmar y asegurar que estén hechos de un material más ligero (titanio) y están mejor contenidos.</li>\n</ul>\n\n<p>Habrá nuevas regulaciones para asegurar que los discos de freno giran a la misma velocidad que las ruedas.</p>\n\n<ul>\n<li>Un sistema de retención y sujeción del neumático con cremallera será obligatorio.</li>\n</ul>'),
(2016, '<h3 style="text-align:center;color:blue;">CAMBIOS EN EL REGLAMENTO DEPORTIVO</h3>\n\n<p>Homologación motores: el 28 de febrero será la fecha máxima para homologar la especificación de la unidad de potencia. En caso de querer modificar la especificación en cuestión, los fabricantes deberán seguir el apéndice 4 del reglamento técnico. Esto significa que durante el año no se podrá re-homologar ningún motor.</p>\n\n<p>Especificaciones de los motores para los equipos: no podrá competir en la F1 cualquier especificación previa a la homologada por el fabricante. O lo que es lo mismo, todos los equipos tendrán a su disposición un motor de última generación.</p>\n<ul> \n<li><strong>Comunicaciones Dirección de Carrera - Equipos:</strong> casi la totalidad de mensajes que sean emitidos por dirección de carrera serán enviados por el sistema oficial de mensajes a todos los equipos, con excepción</li>\n\n<li><strong>Salidas:</strong> Todo piloto que provoque una salida abortada y pueda continuar deberá entrar al pit-lane y empezar la carrera desde el final del mismo. En caso de no hacerlo, se le aplicará la sanción correspondiente.</li>\n\n<li><strong>Modificaciones de setup por efectos meteorológicos:</strong> Los equipos no podrán modificar los elementos permitidos hasta que dirección de carrera no haga llegar el siguiente mensaje: "Change in climatic conditions" ("Cambio en condiciones climáticas").</li>\n\n<li><strong>Tiempos en clasificación:</strong> los comisarios pueden eliminar tiempos en cualquier Gran Premio si ellos consideran que se ha sobrepasado el reglamento.</li>\n\n<li><strong>Límites de la pista:</strong> los pilotos deben intentar por todos los medios no abandonar la pista sin razones justificables. Esto significa que en caso de repetición es probable que se sancione al piloto, aumentando así la mano dura en dichas maniobras.</li>\n\n<li><strong>Cierre de fábricas por vacaciones:</strong> en caso que dos eventos estén separados por veinticuatro días durante Julio o Agosto, las instalaciones de los equipos deberán cerrar durante catorce días consecutivos. En caso que sean diecisiete días los que separen los eventos durante los meses mencionados, las fábricas deberán cerrar trece días. consecutivos.</li>\n\n<li><strong>Toque de queda:</strong> los mecánicos del equipo no podrán trabajar en el coche durante un intervalo de ocho horas que dará comienzo once horas antes de la primera sesión de libres del viernes y del sábado. O lo que es lo mismo, los mecánicos empezarán a trabajar el viernes y el sábado tres horas antes del arranque de los respectivos entrenamientos libres.</li>\n\n<li><strong>Reanudación de la carrera:</strong> los pilotos que tengan problemas tras una bandera roja deberán apartarse del fast-lane. Esto significa que están dando indicaciones para que el resto pueda adelantar. No podrán reincorporarse a la fila hasta que el último vehículo que la forma les haya superado.</li>\n\n<li><strong>Cámara permanente en el coche:</strong> la FIA dispondrá de cámaras propias en cada uno de los coches y que éstos deberán incorporar en todas las sesiones. No confundir con las cámaras de la realización. Estas cámaras de alta velocidad servirán para revisar los datos en caso de accidente o de incidente. Los equipos deben cerciorarse que siempre están en funcionamiento.</li>\n\n<li><strong>Sistema de medición de las Fuerzas G:</strong> todos los pilotos llevarán un sistema conectado a la telemetría de la FIA en sus auriculares para medir las Fuerzas G que se den como resultado de un accidente.</li>\n\n<li><strong>Test con coches de años pasados:</strong> las exhibiciones y/o test deberán ser llevadas a cabo por coches que cumplan el reglamento de 2011. En caso de ser posterior, el equipo deberá informar a la FIA de qué piloto estará en la exhibición, la especificación de motor y chasis correspondiente, lugar en el que se celebrará dicho test/exhibición y la naturaleza e intención del mismo.</li>\n\n<li><strong>Modificaciones en el reglamento:</strong> debe haber decisión unánime por parte de todos los equipos para llevar a cabo cambios en el reglamento deportivo con la excepción que si la FIA considera peligroso alguno de los puntos se podrá modificar sin previo aviso.</li>\n</ul>\n \n<h3 style="text-align:center;color:blue;">CAMBIOS EN EL REGLAMENTO TÉCNICO</h3>\n<ul>\n\n<li><strong>Arranque del monoplaza:</strong> el motor sólo podrá ser arrancado en el garaje, en el pit-lane y en la parrilla de salida.</li>\n\n<li><strong>Cámaras onboard de la FOM:</strong> se regulará la instalación de la misma y los soportes en cuestión para que no sean considerados elementos aerodinámicos. Dichas cámaras tendrán sus lugares específicos que se señalan en los respectivos apéndices del reglamento.</li>\n\n<li><strong>Sistemas de escape:</strong> aparición de un segundo tubo de escape que deberá ser direccionado hacia el centro del monoplaza (tal y como está ahora). No puede haber ningún tipo de carrocería cubriéndolo por completo y ambos tubos de escape deben ocupar el mismo área, siendo gemelos entre sí. A su vez, el turbo sólo podrá tener una salida de residuos.</li>\n\n<li><strong>Modificaciones de reglamento:</strong> debe haber decisión unánime por parte de todos los equipos para llevar a cabo cambios en el reglamento técnico con la excepción que si la FIA considera peligroso alguno de los puntos.</li></ul>');
INSERT INTO `temporada` (`any`, `reglament`) VALUES
(2017, '<h3 style="text-align:center;color:blue;">IGUALDAD DE MOTORES</h3>\n\n<p>La introducción de los motores V6 Turbo en 2014 ha aumentado la eficiencia del motor de combustión interna desde un 29% de aprovechamiento en el año 2013 hasta casi un un 50% en los monoplazas actuales. Además, el hecho de que los sistemas de recuperacón de energía aún no hayan sido exprimidos a sus máximas prestaciones tiende a mejorar la reputación de la filosofía híbrida desde un punto de vista técnico, aunque su falta de atractivo para los aficionados es un punto clave para iniciar algunas modificaciones de cara a la próxima temporada.</p>\n\n<p>Su principal detractor, Bernie Ecclestone, ha cargado en numerosas ocasiones contra la falta de igualdad entre el rendimiento del motor Mercedes y el resto de fabricantes que completan la parrilla.</p> \n\n<p>Pero más allá de las prestaciones puras, circunstancia que estuvo cerca de motivar la llegada de motores independientes más baratos, el dirigente británico ha impulsado un nuevo plan de financiación acorde a las limitaciones económicas de las escuderías independientes, cuya supervivencia en la parrilla parece cada día más inviable bajo el reparto presupuestario actual.</p>\n\n<p>Dado que la Fórmula 1 no podrá introducir una configuración económica más equitativa hasta la firma de un nuevo Pacto de la Condordia en 2020, sus máximos dirigentes planean los siguientes cambios en busca de una mayor competencia por las victorias.</p>\n\n<ol>\n<li>Reducción de los costes. Se aplicará una rebaja de un millón de euros a la manutención de las unidades de potencia, cuyo precio oscila entre los 18 y los 23 millones para los equipos privados. Red Bull ha señalado abiertamente su escepticismo ante este acuerdo, pero los fabricantes se habrían comprometido a flexibilizar sus exigencias para garantizar la sostenibilidad del deporte. Además, el menor gasto podría conllevar la obligación de utilizar un máximo de tres recambios por temporada. Actualmente, el límite está fijado en cinco.</li>\n<li>Igualdad de rendimiento. Los equipos se han marcado el objetivo de asegurar una diferencia por vuelta menor al 2% entre los cuatro motores de la parrilla. Aunque la ventaja de Mercedes sobre Ferrari ya esté fijada sobre un baremo similar, el constante desarrollo de los sistemas híbridos debería dilatar la ventaja de unos fabricantes sobre otros. Por ello, los equipos han utilizado un sistema de medición específico para fijar en "tres décimas" la diferencia aproximada entre los distintas unidades de potencia. De cumplirse esta teoría en el Gran Premio inaugural del 2017, los cambios habrían surgido el efecto deseado.</li>\n<li>Más sonido. El aprovechamiento natural que ejercen los motores híbridos sobre la energía térmica es totalmente contraproducente con la voluntad de aumentar el sonido de los coches. No obstante, las voces internas de la F1 sugieren a la BBC que "se está produciendo un trabajo interesante" para incrementar los decibelios y tapar así uno de los grandes vacíos emocionales en la afición desde la llegada de los V6 Turbo.</li>\n<li>Obligación a suministrar motores. La situación de Red Bull en 2015 ha supuesto un importante punto de inflexión para que la Fórmula 1 evite mayores controversias en el suministro de las unidades de potencia. Los fabricantes podrán seguir reservándose el derecho a fijar su lista deseada de equipos independientes, aunque existe un compromiso firme sobre la mesa para garantizar un motor a cualquier equipo que desee un propulsor, siempre y cuando cumpla con las respectivas condiciones económicas</li>\n</ol>\n \n<h3 style="text-align:center;color:blue;">NEUMÁTICOS MÁS AGRESIVOS</h3>\n\n<p>Pirelli ha estado en el punto de mira frente a la opinión pública desde su entrada a la F1 en 2011. Ya sea por aplicar una configuración demasiado conservadora o incluso introducir neumáticos con una degradación excesiva, la marca milanesa busca de forma desesperada un equilibrio de prestaciones que logre satisfacer a los actores relevantes de la categoría. El Grupo de Estrategia ha exigido cambios que permitan a los pilotos exprimir los límites del monoplaza, rompiendo así con la tendencia actual de cuidar constantemente la degradación en las ruedas traseras.</p>\n\n<p>De esta forma, la F1 ha asignado dos tareas a Pirelli de cara al 2017: aplicar una degradación proporcional al rendimiento de los monoplazas y evitar el desgaste excesivo que se produce generalmente cuando un coche rueda detrás de otro.</p> \n\n<p>Esta situación rompe con la ventana óptima de rendimiento en los PZero hasta reducir el número de adelantamientos, limitando así el espectáculo en las carreras. La FIA pretende que estas soluciones permitan explotar el talento innato de los pilotos sin que la degradación oculte su verdadero potencial al volante.</p>\n\n<p>Aunque los equipos también pidieran una regulación más sensata de las presiones mínimas acorde al rendimiento del neumático, la Federación cree que existen otros asuntos más relevantes donde Pirelli debería centrar sus esfuerzos para reavivar la competición.</p>\n\n \n<h3 style="text-align:center;color:blue;">COCHES MÁS RÁPIDOS</h3>\n\n<p>La necesidad de aumentar la velocidad de los monoplazas se basa en que la naturaleza de los V6 Turbo ocultó la genialidad aerodinámica de los antiguos coches en favor de unos niveles de potencia más ambiciosos en las rectas. Las dos primeras temporadas registraron tiempos más lentos respecto al reglamento de los V8 atmosféricos, pero la llegada de compuestos más blandos en 2016 ha revertido la situación hasta situar los coches actuales como los más rápidos en la última década. \nNo obstante, la falta de agarre en las curvas sigue siendo uno de los asuntos pendientes de mejora en la Fórmula 1 actual. Para ello, la categoría prepara cinco modificaciones esenciales.</p>\n<ol> \n<li>Chasis más anchos, con una distancia de 2 metros entre sus extremos. Se repetirían así las medidas de los coches utilizados hasta el año 1997.</li>\n<li>Un alerón trasero más ancho con un eje de gravedad más bajo, emulando así el clásico concepto de la década de los 90 y principio de los 2000.</li>\n<li>Más carga aerodinámica generada a través del suelo, lo cual reduciría la importancia del alerón delantero como elemento diferenciador en el rendimiento de los monoplazas.</li>\n<li>Neumáticos más anchos para aumentar el agarre mecánico en las curvas. Este cambio sería clave para materializar la reducción de tres segundos por vuelta que barajan en Pirelli.</li>\n</ol>\n\n<p>La apariencia más agresiva de los monoplazas es uno de los temas que más inquieta a Mercedes. Su posición en el asunto de motores parece más flexible de la esperada, aunque nadie niega que en la marca de la estrella existe el temor a perder su supremacía en la parrilla si finalmente se aplicaran los cambios discutidos en el Grupo de Estrategia.</p> \n\n<p>Toto Wolff ya reiteró la pasada temporada que el diseño de los coches actuales ya era suficientemente parecido a las décadas ''de oro'' de la categoría reina, de tal forma que cualquier modificación importante en el apartado técnico carecería de sentido para mejorar la imagen del deporte.</p>\n\n<p>Tras el Gran Premio de China, el propio Wolff reiteró su escepticismo al destacar que la nueva filosofía aerodinámica podría generar el efecto contrario al deseado y reducir el número de adelantamientos sobre la pista. En cualquier caso, los planes de la Federación parecen suficientemente avanzados hacia una revolución drástica en el funcionamiento del deporte. Desde el punto de vista operativo, la FOM trabaja en acoplar el contenido de Fórmula 1 a las nuevas tecnologías con herramientas más accesibles en los portales web y las redes sociales, mientras que el futuro gubernamental de la categoría debería decirise próximamente con un anuncio relevante desde CVC Capital Partners.</p>\n\n<p>El ''Gran Circo'' ultima una transformación clave para mantenerse como un escaparate relevante en el plantel deportivo a nivel mundial. Sólo el tiempo dirá si los esfuerzos por recuperar el espíritu de las carreras antiguas surgen el efecto deseado por sus máximos responsables. Sea como sea, nadie duda de que supone un movimiento arriesgado y aparentemente pertinente antes de modificar las estructuras de poder a partir del año 2020. Fiel a su esencia característica, la Fórmula 1 se prepara para seguir evolucionando hacia el futuro.</p>');
...
CREATE TABLE IF NOT EXISTS `temporada_pilot_escuderia` (
  ...
  KEY `fk_temporada_pilot_escuderia_pilot1_idx` (`pilot_id`),
  KEY `fk_temporada_pilot_escuderia_scuderia1_idx` (`scuderia_id`),
  KEY `fk_temporada_pilot_escuderia_temporada1_idx` (`temporada_any`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
